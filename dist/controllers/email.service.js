...
<body>
  <div class="container">
     ...
     */
    createPasswordResetHtml(params) {
     ...
     */
    sendDailyStatsEmail(toEmail, stats) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    createDailyStatsText(stats, today) {
      ...
      Total Storage: ${(0, statsService_1.formatBytes)(audio.totalStorageBytes)}
      Total Duration: ${(0, statsService_1.formatDuration)(audio.totalDurationSeconds)}
      ...
      Top Users: ${misc.topUsers.map((u) => `${u.name} (${u.prayer_count} prayers, ${u.play_count} plays)`).join('; ')}
     ...
     */
    createDailyStatsHtml(stats, today) {
        const { users, content, ai, audio, misc } = stats;
              ...
              <div style="padding:24px 32px;border-bottom:1px solid #e5e7eb;">
                ...
                <div style="display:flex;gap:16px;flex-wrap:wrap;margin-bottom:16px;">
                  ...
                  <div style="flex:1;min-width:100px;background:#eff6ff;border-radius:8px;padding:12px 16px;text-align:center;">
                    <div style="font-size:24px;font-weight:700;color:#2563eb;">${(0, statsService_1.formatBytes)(audio.totalStorageBytes)}</div>
                    <div style="font-size:11px;color:#6b7280;text-transform:uppercase;">S3 Storage</div>
                  </div>
                  <div style="flex:1;min-width:100px;background:#faf5ff;border-radius:8px;padding:12px 16px;text-align:center;">
                    <div style="font-size:24px;font-weight:700;color:#7c3aed;">${(0, statsService_1.formatDuration)(audio.totalDurationSeconds)}</div>
