...
resource "aws_iam_policy" "lambda_s3_audio" {
  name = "${var.service_name}-s3-audio"
...
resource "aws_iam_role_policy_attachment" "lambda_s3_audio_attach" {
  role       = aws_iam_role.lambda_execution.name
  policy_arn = aws_iam_policy.lambda_s3_audio.arn
}
